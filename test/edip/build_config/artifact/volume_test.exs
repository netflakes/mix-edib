defmodule EdipBuildConfigArtifactVolumeTest do
  use Pavlov.Case
  import Pavlov.Syntax.Expect

  describe "Edip.BuildConfig.Artifact.Volume" do
    # describe "new/2" do
    #   before :each do
    #     allow(Edip.BuildConfig.Artifact.Volume, [:no_link, :passthrough])
    #     |> to_receive(new: fn(from, to, perms) -> :passed end)
    #     :ok
    #   end
    #
    #   it "calls new/3 with default permissions (ro)" do
    #     expect Edip.BuildConfig.Artifact.Volume.new(:from, :to) |> to_eq :passed
    #   end
    # end
    #
    # describe "new/3" do
